...
## Transport Security
- **Content Security Policy (CSP):** The frontend implements a strict CSP that limits script execution to trusted origins and restricts connections to verified API/WebSocket endpoints.
